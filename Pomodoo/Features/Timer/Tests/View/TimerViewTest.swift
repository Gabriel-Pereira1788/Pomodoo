...
final class TimerViewTest:XCTestCase {
    ...
    private func getTimerContentInformations(_ timerView:some View) throws -> (timerIconName:String,timerCount:String,timerDesc:String) {
